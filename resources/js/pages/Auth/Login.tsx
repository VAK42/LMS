        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 rounded-lg shadow-sm">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:border-green-950 dark:focus:border-white transition-colors rounded"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  className="w-4 h-4 border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-green-950 focus:ring-green-950 dark:focus:ring-white accent-green-950 cursor-pointer rounded"
                />
                <label htmlFor="remember" className="ml-2 text-sm text-zinc-700 dark:text-zinc-300 cursor-pointer">
                  {t('rememberMe')}
                </label>
              </div>
              <Link href="/forgotPassword" className="text-sm text-green-950 dark:text-white hover:underline">
                {t('forgotPassword')}
              </Link>
            </div>
            <button
            ...
            <div className="grid grid-cols-2 gap-4">
              <a href="/oauth/google" className="flex items-center justify-center px-4 py-2.5 border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-colors cursor-pointer rounded">
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                  <path fill="currentColor" d="M12.545,10.239v3.821h5.445c-0.712,2.315-2.647,3.972-5.445,3.972c-3.332,0-6.033-2.701-6.033-6.032s2.701-6.032,6.033-6.032c1.498,0,2.866,0.549,3.921,1.453l2.814-2.814C17.503,2.988,15.139,2,12.545,2C7.021,2,2.543,6.477,2.543,12s4.478,10,10.002,10c8.396,0,10.249-7.85,9.426-11.748L12.545,10.239z" />
                </svg>
                {t('google')}
              </a>
              <a href="/oauth/github" className="flex items-center justify-center px-4 py-2.5 border border-zinc-300 dark:border-zinc-700 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors cursor-pointer rounded">
            ...
            <div className="text-center text-sm text-zinc-600 dark:text-zinc-400">
              {t('noAccount')}{' '}
              <Link href="/register" className="text-green-950 dark:text-white hover:underline">
                {t('signUp')}
              </Link>
            </div>
          </form>
