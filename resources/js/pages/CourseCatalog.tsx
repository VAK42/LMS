        ...
        <div className="mb-8 space-y-4">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <select
              ...
              className="px-4 py-3 border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:border-black dark:focus:border-white transition-colors"
            >
            ...
            <button
              ...
              className="px-6 py-3 bg-black dark:bg-white text-white dark:text-black font-medium hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors"
            >
              Search
            </button>
          </div>
