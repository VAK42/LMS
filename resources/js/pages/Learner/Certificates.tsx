    ...
    <Layout user={user}>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-serif font-bold text-black dark:text-white mb-2">{t('myCertificates')}</h1>
        ...
        {certificates.length === 0 ? (
          <div className="text-center py-16 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
            ...
            <h3 className="text-xl font-bold text-black dark:text-white mb-2">{t('noCertificatesYet')}</h3>
            ...
            {certificates.map((cert) => (
              <div key={cert.certificateId} className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                <div className="bg-black dark:bg-white p-6 text-center">
                  ...
                  <h3 className="text-white dark:text-black font-bold">{t('certificateOfCompletion')}</h3>
                </div>
                <div className="p-6">
