      ...
      <div className="min-h-screen bg-gradient-to-br from-zinc-50 to-white dark:from-zinc-900 dark:to-black py-12 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-serif font-bold text-black dark:text-white mb-2">Congratulations!</h1>
            <p className="text-lg text-zinc-600 dark:text-zinc-400">You Have Successfully Completed This Course!</p>
          </div>
          <div className="bg-white dark:bg-zinc-900 border-8 border-black dark:border-white relative overflow-hidden mb-8">
            ...
            <div className="border-4 border-zinc-300 dark:border-zinc-700 m-6 p-12">
              <div className="text-center mb-8 pb-8 border-b-2 border-zinc-200 dark:border-zinc-800">
                ...
                <h2 className="text-5xl font-serif font-bold text-black dark:text-white mb-2">Certificate</h2>
                <p className="text-2xl font-serif text-zinc-600 dark:text-zinc-400">Of Completion</p>
              </div>
              <div className="text-center space-y-6 mb-8">
                <p className="text-lg italic text-zinc-600 dark:text-zinc-400">This Is To Certify That</p>
              ...
              <div className="grid grid-cols-2 gap-12 pt-8 border-t-2 border-zinc-200 dark:border-zinc-800">
                ...
                <div className="text-center">
                  ...
                  <p className="font-bold text-black dark:text-white">{course.instructor?.userName || 'Unknown'}</p>
                </div>
              </div>
              <div className="text-center mt-8 pt-6 border-t border-zinc-200 dark:border-zinc-800">
                <p className="text-xs text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-2">Certificate ID</p>
