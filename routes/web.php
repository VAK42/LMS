...
Route::middleware(['auth', App\Http\Middleware\AdminRouteMiddleware::class])->group(function () {
  ...
  Route::prefix('admin')->middleware('role:admin')->group(function () {
    ...
    Route::post('/reviews', [App\Http\Controllers\Admin\ReviewController::class, 'store']);
    Route::put('/reviews/{reviewId}', [App\Http\Controllers\Admin\ReviewController::class, 'update']);
    Route::delete('/reviews/{reviewId}', [App\Http\Controllers\Admin\ReviewController::class, 'destroy']);
    Route::get('/enrollments/export', [App\Http\Controllers\Admin\EnrollmentController::class, 'export']);
    ...
    Route::put('/enrollments/{userId}/{courseId}', [App\Http\Controllers\Admin\EnrollmentController::class, 'update']);
    Route::delete('/enrollments/{userId}/{courseId}', [App\Http\Controllers\Admin\EnrollmentController::class, 'destroy']);
    Route::get('/coupons/export', [App\Http\Controllers\Admin\CouponController::class, 'export']);
    ...
    Route::get('/support/export', [App\Http\Controllers\Admin\SupportTicketController::class, 'export']);
    ...
    Route::get('/certificates/export', [App\Http\Controllers\Admin\CertificateController::class, 'export']);
    ...
    Route::put('/certificates/{certificateId}', [App\Http\Controllers\Admin\CertificateController::class, 'update']);
    Route::delete('/certificates/{certificateId}', [App\Http\Controllers\Admin\CertificateController::class, 'destroy']);
    Route::get('/notifications/export', [App\Http\Controllers\Admin\NotificationController::class, 'export']);
    ...
    Route::put('/notifications/{notificationId}', [App\Http\Controllers\Admin\NotificationController::class, 'update']);
